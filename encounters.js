...
var e = {
    ...
    SpecialMD:{
        ...
        extra:{
            ...
            {min:8, max:8, name:"Lasker (M9, pg. 128)", text:"Chaotic male dwarf thief 3 is a renknowned pie-maker. Unbeknownst to all, his pies often contain abducted children.", stats:["Lasker"]},
    ...
    SpecialG:{
        ...
        extra:{
            total:40,
            chances:[
            {min:1, max:2, name:"Culver Ringsmith (G1, pg. 142)", text:""},
            {min:3, max:4, name:"Thayco Manslayer and Booginz (G2, pg. 142)", text:""},
            {min:5, max:6, name:"Wareth Drumstrike (G3, pg. 143)", text:""},
            {min:7, max:8, name:"Eltern (G4, pg. 143)", text:""},
            {min:9, max:10, name:"Guillome (G5, pg. 143)", text:""},
            {min:11, max:12, name:"Milago (G6, pg. 145)", text:""},
            {min:13, max:14, name:"Darius Dougle (G7, pg. 145)", text:""},
            {min:15, max:16, name:"Amaryllis Silverfeet (G8, pg. 145)", text:""},
            {min:17, max:18, name:"Fawar/Shelen Tshaziq (G9, pg. 145)", text:""},
            ...
            {min:21, max:22, name:"Borm Morgarm (G11, pg. 146)", text:""},
            {min:23, max:24, name:"Livit Lockhardt (G12), pg. 146", text:""},
            {min:25, max:26, name:"Guildmaster Barik (G13), pg. 146", text:""},
            {min:27, max:28, name:"Tanna Evasho (G14), pg. 146", text:""},
            {min:29, max:30, name:"Madam Toulon (G18, pg. 147)", text:""},
    ...
    SpecialOT:{
        ...
        extra:{
            total:20,
            chances:[
            {min:1, max:1, name:"Elissa Perinor (OT1, pg. 150)", text:""},
            {min:2, max:2, name:"Bofred the Just (OT2, pg. 262)", text:""},
            {min:3, max:3, name:"Danya Darkfeather (OT4, pg. 154)", text:""},
            {min:4, max:4, name:"Ivillivil, Haldor, Purrann, or Thord (OT5, pg. 154)", text:""},
            {min:5, max:5, name:"Ginivarin Krandolve (OT6, pg. 155)", text:""},
            {min:6, max:6, name:"Fanr Flameson (OT7, pg. 156)", text:""},
            {min:7, max:7, name:"Torin Heweth (OT8, pg. 156)", text:""},
            {min:8, max:8, name:"Sister Jenny or Mr. Frown (OT9, pg. 156)", text:""},
            {min:9, max:9, name:"Mistress Gantry (OT10, pg. 156)", text:""},
            {min:10, max:10, name:"Odof Lionsmane, or Sanya (OT11, pg. 156)", text:""},
            {min:11, max:11, name:"Bolo Histan (OT12, pg. 156)", text:""},
            {min:12, max:12, name:"Gilant Narvess (OT13, pg. 156)", text:""},
            {min:13, max:13, name:"Drasil Narben (OT14, pg. 157)", text:""},
            {min:14, max:14, name:"Sventz Borsi (OT15, pg. 157)", text:""},
            {min:15, max:15, name:"Gruden Greybeard (OT16, pg. 157)", text:""},
            {min:16, max:16, name:"Hadro (OT17, pg. 157)", text:""},
            ...
            {min:19, max:19, name:"Watenga (TC2, pg. 113)", text:""},
            {min:20, max:20, name:"Jenette Holycraft (TW27, pg. 244)", text:""}]
        }
    },
    SpecialD:{
        name:"SpecialD",
        extra:{
            total:12,
            chances:[
            {min:1, max:1, name:"Chase (West Docks, D3, pg. 168)", text:""},
            {min:2, max:2, name:"Frenrick (West Docks, D4, pg. 168)", text:""},
            {min:3, max:3, name:"Aicha (West Docks, D2, pg. 168)", text:""},
            {min:4, max:4, name:"Jaeger (D1, pg. 167)", text:""},
            ...
            {min:7, max:7, name:"Felicity Bigh (Night, CAT3, pg. 163)", text:"", stats:["FelicityBigh"]},
            {min:8, max:8, name:"Evan Agrendive (East Docks, ED1, pg. 234)", text:""},
            {min:9, max:9, name:"Widow Waker (East Docks, ED2), pg. 234", text:""},
            {min:10, max:10, name:"Eli (East Docks, ED3), pg. 234", text:""},
            {min:11, max:11, name:"Lasker (Night, M9, pg. 128)", text:"Chaotic male dwarf thief 3 is a renknowned pie-maker. Unbeknownst to all, his pies often contain abducted children and he is stalking the night hunting them now.", stats:["Lasker"]},
    ...
    SpecialC:{
        ...
        extra:{
            total:20,
            chances:[
            {min:1, max:1, name:"Lasker (Night, M9, pg. 128)", text:"Chaotic male dwarf thief 3 is a renknowned pie-maker. Unbeknownst to all, his pies often contain abducted children and he is stalking the night hunting them now.", stats:["Lasker"]},
            {min:2, max:2, name:"Lady Garga (C1, pg. 170)", text:""},
            {min:3, max:3, name:"Tuvio and guards (C2, pg. 170)", text:""},
            {min:4, max:4, name:"Left Eye Lanny (C4, pg. 177)", text:""},
            {min:5, max:5, name:"Scolich (C5, pg. 177)", text:""},
            {min:6, max:6, name:"Asa (C6, pg. 177)", text:""},
    ...
    SpecialK:{
        ...
        extra:{
            ...
            {min:6, max:6, name:"Bofred (Appendix A, pg. 262)", text:""},
    ...
    SpecialO:{
        ...
        extra:{
            ...
            {min:12, max:12, name:"Lasker (Night, M9, pg. 128)", text:"Chaotic male dwarf thief 3 is a renknowned pie-maker. Unbeknownst to all, his pies often contain abducted children and he is stalking the night hunting them now.", stats:["Lasker"]},
